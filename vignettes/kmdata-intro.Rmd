...
references by `A001_2` or `` `TRIBE(2)_2A` `` (with backticks) for data
...
For example, study "A001" has two figures: "1" and "2." Study "A002"
has only one figure: "1." If data sets were part of multi-panel figures, the
name will look similar to study "A003" with figure IDs "2A" and "2B."
